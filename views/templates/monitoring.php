...
<table>
    <thead>
    <tr>   
        <th><a href="?action=monitoring&sort=id&order=<?=$nextOrder?>">Titre</a><?=sortArrow("id",$sort,$order)?></th>
        <th><a href="?action=monitoring&sort=name&order=<?=$nextOrder?>">Commentaire</a><?=sortArrow("name",$sort,$order)?></th>
        <th><a href="?action=monitoring&sort=score&order=<?=$nextOrder?>">Date</a><?=sortArrow("score",$sort,$order)?></th>
        <th><a href="?action=monitoring&sort=date&order=<?=$nextOrder?>">Vues</a><?=sortArrow("date",$sort,$order)?></th>
    </tr>
</thead>
<tbody>
